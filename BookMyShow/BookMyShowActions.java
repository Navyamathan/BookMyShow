...
// class for manage the BookMyShow.BookMyShow Actions
class BookMyShowActions
{
    ...
    // method for to perform BookMyShow.BookMyShow Actions
    public static void start()
    {
        ...
        while (true)
        {
            ...
            {
                BookMyShow.getAdminArrayList().add( new Admin("ADMIN","123")); // add a default data to the BookMyShow.BookMyShow.Admin ArrayList
