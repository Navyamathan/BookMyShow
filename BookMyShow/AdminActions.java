...
// creating a class for the BookMyShow.BookMyShow.Admin Actions
class AdminActions
{
    //this function manage the log in process
    public static Admin adminLogin() // get the parameters values when this function call (this function also returns the object BookMyShow.BookMyShow.Admin)
    {
        System.out.println("WELCOME TO ADMIN LOGIN SYSTEM...");

        for (Admin tempAccount : BookMyShow.getAdminArrayList())  // for loop for checking the username and password one by one in the BookMyShow.BookMyShow.Admin arraylist
        {
            while(true)
            {
                System.out.println();
                ...
                if (username.equals(tempAccount.getUserName())) // checks if the userName is admin ArrayList
                {
                    ...
                    {
                        return tempAccount; // return the BookMyShow.BookMyShow.Admin object
                    }
    ...
    public static void addTheatre()
    {
        ...
        while(true) // loop to check theatre name
        {
            ...
            {
                System.out.println("This BookMyShow.Theatre Is Already Exist, Enter The Valid BookMyShow.Theatre Name!");
            }
            else
            {
                break;
        ...
        {
            System.out.print("Enter Theater BookMyShow.Screen Count: ");
            screenCount = Integer.parseInt(BookMyShowActions.s.nextLine()); // gets the screen count
            if(screenCount <= 0)
            {
                System.out.println("Enter The Valid BookMyShow.Screen Count!");
            }
            else
            {
                break;
        ...
        for (int i = 1; i <= screenCount; i++) // for loop to get the data for screen and store the screen data into the screen HashMap
        {
            ...
            String seatsGrid;
            System.out.println();
            System.out.println("Enter Details About BookMyShow.Screen Number " + i + "...");

            while(true) // loop to check screen name
            {
                System.out.print("Enter BookMyShow.Screen Name: "); // gets the screen name
                screenName = BookMyShowActions.s.nextLine();
                if(theatre.getScreenHashMap().containsKey(screenName))
                {
                    System.out.println("This BookMyShow.Screen Is Already Exist, Enter The Valid BookMyShow.Screen Name!");
                }
                else
                {
                    break;
        ...
        System.out.println();
        System.out.println("BookMyShow.Theatre Added Successfully!");
    }
    ...
    public static void viewTheatre()
    {
        ...
        for(Theatre tempTheatre : BookMyShow.getTheatreHashMap().values()) // loop to manage the theatre HashMap one by one to print the theatre one by one
        {
            if(!theatreFound)
            {
                System.out.println("...Details Of BookMyShow.Theatre...");
                theatreFound =true;
            }
            System.out.println();
            System.out.println("BookMyShow.Theatre Name: "+tempTheatre.getTheatreName());
            System.out.println("BookMyShow.Theatre Location: "+tempTheatre.getTheatreLocation());
            System.out.println("BookMyShow.Screen Count :"+tempTheatre.getScreenCount());
            int i=1;
            ...
            {
                System.out.println();
                System.out.println("Details of BookMyShow.Screen "+i+"...");
                System.out.println("BookMyShow.Screen Name: "+tempScreen.getScreenName());
        ...
        if(!theatreFound) // if theatreFound is false then the theatre list is empty
        {
            System.out.println();
            System.out.println("BookMyShow.Theatre Not Found");
        }
    }
    ...
    public static void addMovie()
    {
        ...
        System.out.println();
        System.out.print("Enter The BookMyShow.Movie Name: ");
        ...
        while(true) // while loop will break when the theatreFound is true
        {
            ...
            {
                System.out.println("There Is No Available BookMyShow.Theatre In The Location You Select");
            }
        }
        ...
        while(true) // loop runs until the theatre are found
        {
            ...
            {
                System.out.println("Enter The Valid BookMyShow.Theatre Name!");
            }
        }
        ...
        while(true) // loop runs until the screen are found
        {
            ...
            {
                System.out.println("Enter The Valid BookMyShow.Screen Name!");
            }
        }
        ...
        while(true) // loop runs util the given show data is not already exist
        {
            ...
            System.out.print("Enter The BookMyShow.Show Starting Time( HH:mm ): ");
            ...
            for(ArrayList<Movie> tempMovieList : BookMyShow.getMovieHashMap().values()) // loop for get the movie HashMap's value which is movie arrayList
            {
                ...
                {
                    if(tempMovie.getShow().getDate().equals(localDate)) // checks the dates are same
                    {
                        if(!tempMovie.getScreen().getScreenName().equals(screenName)) // checks that in the same theatre there will be no shows are starts at the different screen in a same time
                        {
                            if(tempMovie.getShow().getStartingTime().equals(localStartingTime)) // checks if the starting is same or not
                            {
            ...
            {
                System.out.println("The BookMyShow.Show Is Already Exist In Given Time Range, Enter A Valid Starting Time!");
            }
            ...
            {
                System.out.println("The Time You Provided Is The starting Time Of Another BookMyShow.Screen's BookMyShow.Show, Enter The Valid Starting Time!");
            }
        ...
        if(BookMyShow.getMovieHashMap().containsKey(movieName))
        {
            ...
            System.out.println("BookMyShow.Movie Added Successfully!");
        }
    ...
    public static void viewMovie()
    {
        ...
        for(String tempMovieKey : BookMyShow.getMovieHashMap().keySet()) // loop for get the movie HashMap's value which is movie arrayList
        {
            ...
            System.out.println();
            System.out.println("BookMyShow.Movie Name: " + tempMovieKey);
            System.out.println("----------------------------");
            for(Movie tempMovie : BookMyShow.getMovieHashMap().get(tempMovieKey)) // loop for get the movie Arraylist one by one to get all the shows in the movie arrayList
            {
                ...
                System.out.println("BookMyShow.Theatre: " + tempMovie.getTheatre().getTheatreName());
                System.out.println("BookMyShow.Screen: " + tempMovie.getScreen().getScreenName());
                System.out.println("BookMyShow.Show Starting Time: " + tempMovie.getShow().getStartingTime());
                System.out.println("BookMyShow.Show Ending Time: " + tempMovie.getShow().getEndingTime());
            }
        }
        if(!movieFound)
        {
            System.out.println("BookMyShow.Movie Not Found");
        }
    }
