...
// pojo BookMyShow.Movie class to maintain and manage the movie data
public class Movie
{
    ...
    private Theatre theatre; // stores the BookMyShow.Theatre object in where the movie is going to run
    private Screen screen; // stores the BookMyShow.Screen object in where the movie is going to run
